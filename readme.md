...
Software Engineer at **[Codexist](https://codex.ist)** (Istanbul).
...
> Closed-source work at Codexist — full detail in the CV.

**🏢 &nbsp;AI-Powered Real Estate Platform** — a domain-driven backend behind two React apps, with LLM
pipelines that turn appraisal reports into structured property data.
`Java 21` `Spring Boot` `DDD` `jOOQ` `PostgreSQL` `Keycloak` `Redis` `RabbitMQ`

**🏧 &nbsp;Self-Service Gold-Retail Kiosk** — an unattended retail product, from the backend down to POS
terminals and thermal receipt printers.
`Spring Boot` `React` `Python / Flask` `Linux` `ESC/POS`

**🧩 &nbsp;Logic Loom** — a Flutter puzzle app: 15 games, each with its own solver and generator.
`Flutter` `Dart`
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/osmntahir/osmntahir/output/github-contribution-grid-snake-dark.svg?v=4"/>
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/osmntahir/osmntahir/output/github-contribution-grid-snake.svg?v=4"/>
  <img width="100%" src="https://raw.githubusercontent.com/osmntahir/osmntahir/output/github-contribution-grid-snake.svg?v=4" alt="Snake eating the contribution grid"/>
</picture>
